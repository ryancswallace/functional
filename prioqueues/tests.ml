 ...
 * /client/ of the IntTree module cannot know this, because the module 
 * signature doesn't reveal it. The client of the IntTree module can only know
 * what is provided by the signature: "BINTREE with type elt = C.t" found in
 * the definition of the BinSTree functor.
